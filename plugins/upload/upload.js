...
var plugin={
    ...
    init:function(ele,args,callback){
        ...
        self.config=args;
            ...
            self.uploaderInit(ele,self.config.list,self.config.parent,ur,self.config.input,self.config.type);
            $(".err-up").css({
    ...
    uploaderInit:function(btn,list,parent,url,inp,type){
    ...
    removeFile:function(uploader,inp){
        var self=this;
